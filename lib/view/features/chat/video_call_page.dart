...
// import 'package:mindintrest_user/view/features/chat/participant_widget.dart';
// import 'package:mindintrest_user/view/features/chat/room/room_model.dart';
// import 'package:mindintrest_user/view/features/chat/widgets/conference_button_bar.dart';
// import 'package:mindintrest_user/view/features/chat/widgets/draggable_publisher.dart';
// import 'package:mindintrest_user/view/features/chat/widgets/noise_box.dart';
// import 'package:mindintrest_user/view/features/chat/widgets/platform_alert_dialogue.dart';
// import '../../../core/state/twilio_blocs/twilio_cubit.dart';
...
//       );
//       await conferenceRoom.connect(isAudio:widget.roomModel.isAudio);
//       setState(() {
...
//       // = participants.firstWhereOrNull((ParticipantWidget participant) => participant.isRemote);
...
// //     return Scaffold(
// //       backgroundColor: Colors.black,
// //       body: BlocProvider(create: (BuildContext context) => ConferenceRoom(name: widget.name, token: widget.token, identity: widget.identity),
// //         child: Column(
// //           children: [
// //             Expanded(child: Container(
// //               width: MediaQuery.of(context).size.width,
// //               height: MediaQuery.of(context).size.height,
// //               child: BlocConsumer<ConferenceRoom, TwilioState>(
// //                   listener: (context, state) {
// //                     if(state is TwilioFailed){
// //                       TMIAlerts.showError(context,message:"Could not connect");
// //                       // Navigator.pop(context);
// //                     }
// //                   },
// //                   builder: (context, state) {
// //                     if (state is TwilioInitial) {
// //                       return showProgress();
// //                     }
// //
// //                     if (state is TwilioLoaded) {
// //                       return Stack(
// //                         children: <Widget>[
// //                           _buildParticipants(context),
// //
// //                           Align(child: ElevatedButton(
// //                             style: ButtonStyle(backgroundColor: MaterialStateProperty.resolveWith(getColor),shape: MaterialStateProperty.all(CircleBorder())),
// //                             onPressed: () async {
// //                               context.read<ConferenceRoom>().disconnect();
// //                               Navigator.of(context).pop();
// //                             },
// //                             child: Icon(
...
// //     final TwilioRoom = context.read<ConferenceRoom>();
// //     final participants = TwilioRoom.participants;
